...
#import "CivilPracticeandRemediesView.h"

@implementation CivilPracticeandRemediesCodeView {
    NSArray * categorey;
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"CivilPracticeandRemediesCode" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CivilPracticeandRemediesView *myViewController = [[CivilPracticeandRemediesView alloc] init];
