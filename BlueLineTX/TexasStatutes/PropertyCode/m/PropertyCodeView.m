...
@implementation PropertyCodeView {
    NSArray * categorey;
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"PropertyCode" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PropertyView *myViewController = [[PropertyView alloc] init];
