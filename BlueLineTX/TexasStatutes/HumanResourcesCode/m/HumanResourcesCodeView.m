...
#import "HumanResourcesView.h"

@implementation HumanResourcesCodeView {
    NSArray * categorey;
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"HumanResourcesCode" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HumanResourcesView *myViewController = [[HumanResourcesView alloc] init];
