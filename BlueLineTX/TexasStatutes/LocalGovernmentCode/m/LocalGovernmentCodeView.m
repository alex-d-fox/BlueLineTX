...
#import "LocalGovernmentView.h"

@implementation LocalGovernmentCodeView {
    NSArray * categorey;
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"LocalGovernmentCode" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LocalGovernmentView *myViewController = [[LocalGovernmentView alloc] init];
