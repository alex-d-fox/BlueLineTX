...
#import "CriminalProcedureView.h"

@implementation CriminalProcedureCodeView {
    NSArray * categorey;
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"CriminalProcedureCode" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CriminalProcedureView *myViewController = [[CriminalProcedureView alloc] init];
