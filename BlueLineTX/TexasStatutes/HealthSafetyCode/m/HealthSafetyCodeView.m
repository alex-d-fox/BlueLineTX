...
#import "HealthSafetyView.h"

@implementation HealthSafetyCodeView {
    NSArray * categorey;
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"HealthSafetyCode" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HealthSafetyView *myViewController = [[HealthSafetyView alloc] init];
