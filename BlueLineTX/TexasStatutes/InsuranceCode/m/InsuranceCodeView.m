...
@implementation InsuranceCodeView {
    NSArray * categorey;
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"InsuranceCode" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    InsuranceView *myViewController = [[InsuranceView alloc] init];
