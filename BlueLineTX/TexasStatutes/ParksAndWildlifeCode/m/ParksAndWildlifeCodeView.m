...
#import "ParksAndWildlifeView.h"

@implementation ParksAndWildlifeCodeView {
    NSArray * categorey;
}
...
+ (NSString *)title {
	return @"Parks And Wildlife Code";
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"ParksAndWildlifeCode" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ParksAndWildlifeView *myViewController = [[ParksAndWildlifeView alloc] init];
