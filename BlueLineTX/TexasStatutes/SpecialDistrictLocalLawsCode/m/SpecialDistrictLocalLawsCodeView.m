...
#import "SpecialDistrictLocalLawsView.h"

@implementation SpecialDistrictLocalLawsCodeView {
    NSArray * categorey;
}
...
+ (NSString *)title {
	return @"Special District Local Laws Code";
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"SpecialDistrictLocalLawsCode" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SpecialDistrictLocalLawsView *myViewController = [[SpecialDistrictLocalLawsView alloc] init];
