...
#import "BusinessOrgView.h"

@implementation BusinessOrgCodeView {
    NSArray * categorey;
}
...
+ (NSString *)title {
	return @"Business Organizations Code";
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"BusinessOrgCode" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BusinessOrgView *myViewController = [[BusinessOrgView alloc] init];
