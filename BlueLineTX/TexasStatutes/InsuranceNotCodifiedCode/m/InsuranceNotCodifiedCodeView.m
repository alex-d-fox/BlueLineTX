...
#import "InsuranceNotCodifiedView.h"

@implementation InsuranceNotCodifiedCodeView {
    NSArray * categorey;
}
...
+ (NSString *)title {
	return @"Insurance Code Not Codified";
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"InsuranceNotCodifiedCode" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    InsuranceNotCodifiedView *myViewController = [[InsuranceNotCodifiedView alloc] init];
