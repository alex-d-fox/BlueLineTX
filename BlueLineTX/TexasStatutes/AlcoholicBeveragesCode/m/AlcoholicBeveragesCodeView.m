...
#import "AlcoholicBeveragesView.h"

@implementation AlcoholicBeveragesCodeView {
    NSArray * categorey;
}
...
+ (NSString *)title {
	return @"Alcoholic Beverages Code";
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"AlcoholicBeveragesCode" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    AlcoholicBeveragesView *myViewController = [[AlcoholicBeveragesView alloc] init];
