...
#import "AuxWaterLawsView.h"
#import "AuxWaterView.h"

@implementation AuxWaterLawsView {
    NSArray * categorey;
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"AuxWaterLaws" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    AuxWaterView *myViewController = [[AuxWaterView alloc] init];
