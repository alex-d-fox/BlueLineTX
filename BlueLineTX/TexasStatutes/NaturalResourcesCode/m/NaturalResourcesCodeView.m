...
#import "NaturalResourcesView.h"

@implementation NaturalResourcesCodeView {
    NSArray * categorey;
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSString* plistPath = [[NSBundle mainBundle] pathForResource:@"NaturalResourcesCode" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NaturalResourcesView *myViewController = [[NaturalResourcesView alloc] init];
